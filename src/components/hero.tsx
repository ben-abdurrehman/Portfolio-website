  ...
  return (
    <section className="relative flex flex-col items-center justify-start min-h-[90vh] md:min-h-[100vh] bg-black py-20 text-white overflow-hidden px-4">
      ...
      <div className="absolute top-64 md:top-32 bottom-0 right-0 z-10 flex justify-center w-full h-full">
        <div className="w-80 h-[600px] md:w-[400px] overflow-hidden  shadow-xl">
          <div className="absolute rounded-full w-full lg:w-1/2 h-full mx-auto -z-10 inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(1,182,212,0.7),transparent_50%)]"></div>
          <Image
            className=" mx-auto select-none grayscale z-20 w-80 h-[500px] lg:w-80 lg:h-[600px]"
            src="/bg-remove2.png"
